      ...
      <div className={classNames('relative flex flex-col gap-2', className)}>
        ...
        <input
          ...
          className={classNames(
            'h-fit w-full appearance-none rounded border border-neutral-700 bg-neutral-800 px-3 py-1.5 text-sm font-light outline-none transition-all placeholder:text-neutral-500 read-only:cursor-not-allowed focus:ring-1 focus:ring-blue-500',
            className
          )}
          {...rest}
        />
